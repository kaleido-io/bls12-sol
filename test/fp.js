...
describe('Fp lib', function () {
  ...
  it('add() with overflow', async () => {
    const fp1 = parseFp('0x1a0111ea397fe69a4b1ba7b6434bacd764774b84f38512bf6730d2a0f6b0f6241eabfffeb153ffffb9fefffcb7a6aa64');
    const result = await fplib.add(fp1, fp1);
    const expected = parseFp('0x1a0111ea397fe69a4b1ba7b6434bacd764774b84f38512bf6730d2a0f6b0f6241eabfffeb153ffffb9fefff96f4daa1d');
    verify(result, expected);
  });
