...
describe('Fp2 lib', function () {
  ...
  it('add()', async () => {
    ...
    verify(result, { a: expected_a, b: expected_b });
  });
...
function verify(result, expected) {
  assert.equal('0x' + result.a.a.toString(16).padStart(64, '0'), expected.a.a);
  assert.equal('0x' + result.a.b.toString(16).padStart(64, '0'), expected.a.b);
  assert.equal('0x' + result.b.a.toString(16).padStart(64, '0'), expected.b.a);
  assert.equal('0x' + result.b.b.toString(16).padStart(64, '0'), expected.b.b);
}
